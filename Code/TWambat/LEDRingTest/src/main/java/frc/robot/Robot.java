...
public class Robot extends TimedRobot 
{
  ...
  NetworkTableEntry mHighValue;
  NetworkTableEntry mLowValue;
...
@Override
  public void robotInit() 
  {
    ...
    mLowValue  = inst.getEntry("/rp/low");
    mHighValue = inst.getEntry("/rp/high");  
  }
...
@Override
  ...
  {
    mLowValue.setDouble(mJoystick.getRawAxis(2)*255);
    mHighValue.setDouble(mJoystick.getRawAxis(3)*255);
    
    System.out.format("%f %f\n",mJoystick.getRawAxis(2)*255,mJoystick.getRawAxis(3)*255);
