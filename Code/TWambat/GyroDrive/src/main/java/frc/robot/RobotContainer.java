...
import frc.robot.commands.TurnToCenterLowGoal;
...
public class RobotContainer {
  ...
  private final RaspPiCamera m_raspPiCam = new RaspPiCamera();
  ...
  private void configureButtonBindings() {
    ...
    // Turn to center of low goalt
    new JoystickButton(m_driverController, Button.kB.value)
        .whenPressed(new TurnToCenterLowGoal(0, m_robotDrive, m_raspPiCam).withTimeout(5));
  }
