...
public class DriveSubsystem extends SubsystemBase {
  ...
  public void periodic() {
    ...
    sOdometry.update(Rotation2d.fromDegrees(getHeading()),
  ...
  public DifferentialDriveWheelSpeeds getWheelSpeeds() {
    return new DifferentialDriveWheelSpeeds(sMotorLeftA.getSelectedSensorVelocity(), 
                                            sMotorRightA.getSelectedSensorVelocity());
  }
