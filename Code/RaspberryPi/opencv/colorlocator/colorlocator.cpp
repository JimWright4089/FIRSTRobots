...
int main(int argc, char** argv)
{
  ...
  createTrackbar("LowH", "Control", 0, 255, NULL); //Hue (0 - 179)
  createTrackbar("HighH", "Control", 0, 255, NULL);

  createTrackbar("LowS", "Control", 0, 255, NULL); //Saturation (0 - 255)
  createTrackbar("HighS", "Control", 0, 255, NULL);

  createTrackbar("LowV", "Control", 0, 255, NULL); //Value (0 - 255)
  createTrackbar("HighV", "Control", 0, 255, NULL);
  ...
  //morphological opening (remove small objects from the foreground)
    ...
    */
    ...
    for (int i = 0; i < mContours.size(); i++)
    {
      ...
      if ((area > 2000) && (circle > largestArea))
      {
        largestArea = circle;
        largestCirc = circle;
        largestCont = i;
