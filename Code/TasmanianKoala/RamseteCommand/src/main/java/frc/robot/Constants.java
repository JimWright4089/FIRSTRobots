...
public final class Constants {
  public static final class DriveConstants {
    ...
    public static final double ksVolts = 0.0367;
    public static final double kvVoltSecondsPerMeter = 2.03;
    public static final double kaVoltSecondsSquaredPerMeter = 0.11;

    // Example value only - as above, this must be tuned for your drive!
    public static final double kPDriveVel = 4.39;
