...
public class FollowPath extends CommandGroup {
  ...
  public void InitPath(String name) {
    try
    {
      ...
      RobotMap.sLeftFollower.configureEncoder(RobotMap.sMotorLeftA.getSelectedSensorPosition(0), 
      ...
      RobotMap.sRightFollower.configureEncoder(RobotMap.sMotorRightA.getSelectedSensorPosition(0), 
      Constants.k_ticks_per_rev, Constants.k_wheel_diameter);
      // You must tune the PID values on the following line!
  ...
  private void followPath() {
    if (isFinished()) {
      ...
      double left_speed = RobotMap.sLeftFollower.calculate(RobotMap.sMotorLeftA.getSelectedSensorPosition(0));
      double right_speed = RobotMap.sRightFollower.calculate(RobotMap.sMotorRightA.getSelectedSensorPosition(0));
      ...
      RobotMap.sMotorLeftA.set(left_speed + turn);
      RobotMap.sMotorRightA.set(right_speed - turn);
    }
  }
}
