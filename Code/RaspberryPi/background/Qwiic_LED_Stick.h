...
class LED
{
  ...
  public:
	...
	bool begin(uint8_t address = 0x23);//If user doesn't specificy then 0x23 and Wire will be used
    ...
    bool setLEDColor(uint8_t number, uint8_t red, uint8_t green, uint8_t blue);
	...
	bool changeLength(uint8_t newLength);
