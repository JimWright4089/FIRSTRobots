...
def main(config):
    ...
    ntCenterX = ntinst.getTable("ML").getEntry("centerX")
    ntCenterY = ntinst.getTable("ML").getEntry("centerY")
    ntArea    = ntinst.getTable("ML").getEntry("area")
...
#        print(detections)
        ...
        ntArea.setDouble(area)
        ntCenterX.setDouble(centerX)
        ntCenterY.setDouble(centerY)
#        detections_entry.setString("Hi there");
#.putString(json.dumps(detections))
